...
![no bank conflict example](../../../assets/images/cuda-memory-optimization/1.jpg)
...
![no bank conflict example](../../../assets/images/cuda-memory-optimization/2.jpg)
...
![2-way bank conflict example](../../../assets/images/cuda-memory-optimization/3.jpg)
...
![2-way bank conflict example](../../../assets/images/cuda-memory-optimization/4.jpg)
...
![2-dim thread-block structure example without 16-way bank conflict](../../../assets/images/cuda-memory-optimization/5.jpg)

위 그림과 같이 행 방향으로만 인덱스를 진행할 경우 뱅크 충돌이 발생하지 않고 정상적으로 동작하게 됩니다. 하지만 열 방향으로 인덱스를 진행하면 아래와 같이 뱅크 충돌이 발생할 수 있습니다.

![2-dim thread-block structure example with 16-way bank conflict](../../../assets/images/cuda-memory-optimization/6.jpg)
...
![solution for 16-way bank conflict example](../../../assets/images/cuda-memory-optimization/7.jpg)
